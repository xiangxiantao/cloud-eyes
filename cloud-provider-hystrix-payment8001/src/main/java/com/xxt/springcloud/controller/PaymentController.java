...
public class PaymentController {
    ...
    public Object discovery(){
        ...
        List<ServiceInstance> instances = discoveryClient.getInstances("CLOUD-PAYMENT-HYSTRIX-SERVICE");
    ...
    public String longTimeJob() {
        return paymentService.longTimeJob()+port;
    }
    ...
    @GetMapping(value = "/payment/cb/{id}")
    public String ping(@PathVariable Integer id){
        log.info("get cb");
        return paymentService.paymentCitcuitBreaker(id);
    }
